...
export default function RegistrarPagos({ invoices, onUpdatePayment, systemDate, clients = [] }: RegistrarPagosProps) {
  ...
  // Filter invoices based on docType, search & category
  const filtered = invoices.filter((inv) => {
    ...
    const matchesSearch =
      ...
      (inv.numero && inv.numero.includes(search)) ||
      (inv.remisionNumero && inv.remisionNumero.includes(search));
    
    const matchesCategory = selectedCategory === 'All' || inv.category === selectedCategory;
    
    return matchesDocType && matchesSearch && matchesCategory;
  });
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-1.5 items-center justify-between">
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                {/* Selector de Categoría con flecha */}
                <div className="relative">
                  <select
